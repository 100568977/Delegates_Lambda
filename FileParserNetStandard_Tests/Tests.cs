...
namespace FileParserNetStandard_Tests {
    ...
    public class Tests {
        ...
        private string _csvPath = @"C:\Users\kbke2\Desktop\TAFE 2018\Dev Ops\Week 7\Files\data.csv";  // change to appropriate path
        private string _tsvPath = @"C:\Users\kbke2\Desktop\TAFE 2018\Dev Ops\Week 7\Files\data.tsv";  // change to appropriate path

        private string _writeFile = @"C:\Users\kbke2\Desktop\TAFE 2018\Dev Ops\Week 7\Files\datawriter.csv";  // change to appropriate path
